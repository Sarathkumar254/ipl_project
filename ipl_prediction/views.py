...
def predict(request):
    ...
    if request.method == 'POST':
        ...
        my_prediction = abs(int(regressor.predict(data)[0]))
        data = {"lower_limit":my_prediction - 5, "upper_limit":my_prediction + 5}
        return render(request, 'ipl_prediction/result.html', {'result': data})
